		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form role="form" class="login100-form validate-form" action="prosesdaftar.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
					Tanggal Lahir
						<input class="input100" type="date" name="ttl" autofocus required/> 
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input class="input100" type="text" name="alamat" autofocus required/>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input class="input100" type="text" name="username" autofocus required/>
