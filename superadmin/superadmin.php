...
<div id="sidebar"><a href="admin.php" class="visible-phone"><i class="icon icon-home"></i>Dashboard</a>
  <ul>
    <li class="active"><a href="superadmin.php"><span>Dashboard</span></a></li>
    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lo"> <a href="tingkat.php"> <i class="icon-th-list"></i>Tingkat</a> </li>
		 <li class="bg_lb"> <a href="tingkat.php"> <i class="icon-th-list"></i>Admin</a> </li>
        ...
        <div class="widget-content">
            <div class="span6" >
			  ...
			  <li class="bg_lh"><i class="icon-user" ></i> <strong>
				 <?php $sql="SELECT count(*) AS jumlah FROM admin WHERE admin.level='admin'";
					$hasil=mysqli_query($koneksi,$sql);
					$data=mysqli_fetch_array($hasil);
					echo "{$data['jumlah']}";
				?>
				</strong> <small>Admin</small></li>
                <li class="bg_lh"><i class="icon-user" ></i> <strong>
