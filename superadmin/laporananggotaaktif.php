        ...
        <div class="widget-box">
		  ...
		  <?php
			...
			$tgl_selesai="-";
				...
				$sql=$koneksi->query("SELECT * FROM faktur_peminjaman JOIN mahasiswa ON faktur_peminjaman.nim=mahasiswa.nim WHERE tgl_pinjam BETWEEN '$tgl_mulai' AND '$tgl_selesai'");
				while($data=$sql->fetch_assoc()){
					$semuadata[]=$data;
				}
				}
			?>
            <h5>Laporan Anggota yang Aktif dari <?php echo $tgl_mulai ?> sampai <?php echo $tgl_selesai?></h5>
          </div>
		  <hr>
