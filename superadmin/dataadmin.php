...
<li><a href="superadmin.php"><span>Dashboard</span></a></li>
	...
	<li class="active"><a href="dataadmin.php"><i class="icon-dashboard"></i><span>Admin</span></a></li>
</div>
<!--sidebar-menu-->
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin.php" title="Go to Dashboard" class="tip-bottom"><i class="icon-home"></i>Dashboard</a> <a href="dataadmin.php" class="current">Admin</a> </div>
    <h1>Data Admin</h1>
  </div>
        ...
        <div class="widget-box">
		 ...
		 <div class="panel-body">
		  ...
		  <div class="widget-content nopadding">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM admin WHERE admin.level='admin'";
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahadmin.php?username=<?php echo $data['username']?>" class="btn btn-info">Ubah</a>
						<a href="hapusadmin.php?username=<?php echo $data['username']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
