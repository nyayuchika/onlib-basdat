  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lo"> <a href="laporananggotapasif.php"> <i class="icon-th-list"></i>Anggota Pasif</a> </li>
        ...
        <div class="widget-box">
		  ...
		  <?php
			...
			$tgl_selesai="-";
				...
				$sql=$koneksi->query("SELECT * FROM faktur_peminjaman JOIN mahasiswa ON faktur_peminjaman.nim=mahasiswa.nim WHERE faktur_peminjaman.nim='0' AND tgl_pinjam BETWEEN '$tgl_mulai' AND '$tgl_selesai'");
				while($data=$sql->fetch_assoc()){
					$semuadata[]=$data;
				}
				}
			?>
            <h5>Laporan Anggota yang Pasif dari <?php echo $tgl_mulai ?> sampai <?php echo $tgl_selesai?></h5>
          </div>
		  <hr>
