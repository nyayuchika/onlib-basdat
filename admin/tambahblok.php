        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal">
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="id_blok" class="span11"/>
              </div>
            </div>
            <label class="control-label">
			  ...
			  <?php $sql="SELECT * FROM ruang";
				...
				while ($data = mysqli_fetch_array($hasil)){?>
					<option value="<?php echo $data['id_ruang'];?>">
					<?php echo $data['nama_ruang'];?></option>
					<?php } } ?>
			</select>
			</div>
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="nama_blok" class="span11"/>
              </div>
            </div>
			...
			<?php
				...
				{
				$sql=$koneksi->query("INSERT INTO blok(id_blok,id_ruang,nama_blok) VALUES('$_POST[id_blok]','$_POST[id_ruang]','$_POST[nama_blok]')");
				if($sql)
				{
					echo "<script>alert('Data berhasil ditambahkan'); window.location = 'blok.php'</script>";
				}
				else
				{
					echo "<script>alert('Proses gagal'); window.location = 'tambahblok.php'</script>";
				}
				}
			?>
          </form>
