        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM mengarang JOIN buku ON mengarang.id_buku=buku.id_buku JOIN pengarang ON mengarang.id_pengarang=pengarang.id_pengarang";
			...
			<a href="tambahmengarang.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
