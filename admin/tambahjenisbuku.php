        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal">
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="id_jenis" class="span11"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Jenis :</label>
              <div class="controls">
                <input type="text" name="nama_jenis" class="span11"/>
              </div>
            </div>
			...
			<?php
				...
				{
				$sql=$koneksi->query("INSERT INTO jenis_buku(id_jenis,nama_jenis) VALUES('$_POST[id_jenis]','$_POST[nama_jenis]')");
				if($sql)
				{
					echo "<script>alert('Data berhasil ditambahkan'); window.location = 'jenisbuku.php'</script>";
				}
				else
				{
					echo "<script>alert('Proses gagal'); window.location = 'tambahjenisbuku.php'</script>";
				}
				}
			?>
          </form>
