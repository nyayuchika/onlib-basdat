        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM blok,ruang WHERE blok.id_ruang=ruang.id_ruang";
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahblok.php?id_blok=<?php echo $data['id_blok']?>" class="btn btn-info">Ubah</a>
						<a href="hapusblok.php?id_blok=<?php echo $data['id_blok']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahblok.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
