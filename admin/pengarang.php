        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahpengarang.php?id_pengarang=<?php echo $data['id_pengarang']?>" class="btn btn-info">Ubah</a>
						<a href="hapuspengarang.php?id_pengarang=<?php echo $data['id_pengarang']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahpengarang.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
