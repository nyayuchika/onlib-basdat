        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahfakultas.php?id_fakultas=<?php echo $data['id_fakultas']?>" class="btn btn-info">Ubah</a>
						<a href="hapusfakultas.php?id_fakultas=<?php echo $data['id_fakultas']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahfakultas.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
