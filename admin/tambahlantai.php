        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal">
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="id_lantai" class="span11"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Lantai :</label>
              <div class="controls">
                <input type="text" name="nama_lantai" class="span11"/>
              </div>
            </div>
			...
			<?php
				...
				{
				$sql=$koneksi->query("INSERT INTO lantai(id_lantai,nama_lantai) VALUES('$_POST[id_lantai]','$_POST[nama_lantai]')");
				if($sql)
				{
					echo "<script>alert('Data berhasil ditambahkan'); window.location = 'lantai.php'</script>";
				}
				else
				{
					echo "<script>alert('Proses gagal'); window.location = 'tambahlantai.php'</script>";
				}
				}
			?>
          </form>
