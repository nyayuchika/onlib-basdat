        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="nama_mahasiswa" class="span11"/>
              </div>
            </div>
			<div class="control-group">
			...
			<?php
				...
				{
				$sql=$koneksi->query("INSERT INTO mahasiswa VALUES('$_POST[nim]','$_POST[id_jurusan]','$_POST[nama_mahasiswa]','$_POST[jk]','$_POST[email]','$_POST[password]')");
				if($sql)
				{
				...
				{
					echo "<script>alert('Proses gagal'); window.location = 'tambahanggota.php'</script>";
				}
				}
			?>
          </form>
