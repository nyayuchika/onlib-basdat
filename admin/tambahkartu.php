        ...
        <div class="widget-box">
          ...
          <form method="post" class="form-horizontal">
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="no_kartu" class="span11"/>
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">NIM :</label>
              <div class="controls">
                <input type="text" name="nim" class="span11"/>
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Total Buku Dipinjam :</label>
              <div class="controls">
                <input type="text" name="total_buku" class="span11"/>
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Tanggal Pinjam :</label>
              <div class="controls">
                <input type="date" name="tgl_pinjam" class="span11"/>
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Tanggal Batas Pinjam :</label>
              <div class="controls">
                <input type="date" name="tgl_batas_pinjam" class="span11"/>
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Tanggal Kembali :</label>
              <div class="controls">
                <input type="date" name="tgl_kembali" class="span11"/>
              </div>
            </div>
			<div class="control-group">
              <label class="control-label">Denda :</label>
              <div class="controls">
                <input type="hidden" name="denda" class="span11"/>
              </div>
            </div>
			...
			<?php
				...
				{
				$sql=$koneksi->query("INSERT INTO faktur_peminjaman VALUES('$_POST[no_kartu]','$_POST[nim]','$_POST[total_buku]','$_POST[tgl_pinjam]','$tgl_batas_pinjam','$_POST[tgl_kembali]','$denda')");
				if($sql)
				{
					echo "<script>alert('Data berhasil ditambahkan'); window.location = 'kartu.php'</script>";
				}
				else
				{
					echo "<script>alert('Proses gagal'); window.location = 'tambahkartu.php'</script>";
				}
				}
			?>
          </form>
