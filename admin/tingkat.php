        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM tingkat,rak WHERE tingkat.id_rak=rak.id_rak";
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahtingkat.php?id_tingkat=<?php echo $data['id_tingkat']?>" class="btn btn-info">Ubah</a>
						<a href="hapustingkat.php?id_tingkat=<?php echo $data['id_tingkat']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahtingkat.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
