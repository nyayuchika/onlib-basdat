        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM jurusan,fakultas WHERE jurusan.id_fakultas=fakultas.id_fakultas";
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahjurusan.php?id_jurusan=<?php echo $data['id_jurusan']?>" class="btn btn-info">Ubah</a>
						<a href="hapusjurusan.php?id_jurusan=<?php echo $data['id_jurusan']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
