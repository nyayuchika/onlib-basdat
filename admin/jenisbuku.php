        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahjenisbuku.php?id_jenis=<?php echo $data['id_jenis']?>" class="btn btn-info">Ubah</a>
						<a href="hapusjenisbuku.php?id_jenis=<?php echo $data['id_jenis']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahjenisbuku.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
