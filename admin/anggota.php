        ...
        <div class="widget-box">
		 ...
		 <div class="panel-body">
		  ...
		  <div class="widget-content nopadding">
			...
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahanggota.php?nim=<?php echo $data['nim'];?>" class="btn btn-info">Ubah</a>
						<a href="hapusanggota.php?nim=<?php echo $data['nim'];?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahanggota.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
		</div>
      </div>
