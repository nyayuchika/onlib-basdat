        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM kelompok_buku JOIN jenis_buku ON kelompok_buku.id_jenis=jenis_buku.id_jenis";
			$hasil=mysqli_query($koneksi, $sql);?>
              <thead>
                <tr>
                  <th>No</th>
				  <th>ID Kelompok Buku</th>
				   <th>Jenis Buku</th>
                  <th>Kelompok Buku</th>
				  <th>Keterangan</th>
                </tr>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahkelompokbuku.php?id_kelompok=<?php echo $data['id_kelompok']?>" class="btn btn-info">Ubah</a>
						<a href="hapuskelompokbuku.php?id_kelompok=<?php echo $data['id_kelompok']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahkelompokbuku.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
		</div>
      </div>
