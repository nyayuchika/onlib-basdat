  ...
  <ul>
	...
	<li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Fakultas & Jurusan</span> <span class="label label-important">2</span></a>
      <ul>
        ...
        <li class="active"><a href="jurusan.php"><span>Jurusan</span></a></li>
		</ul>
    </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin.php" title="Go to Dashboard" class="tip-bottom"><i class="icon-home"></i>Dashboard</a> <a href="jurusan.php" class="current">Jurusan</a> </div>
    <h1>Ubah</h1>
  </div>
  <?php
	include "config.php";
	if(isset($_POST['kirim']))
	{
		...
		$sql="UPDATE jurusan SET id_jurusan='$id_jurusan', nama_jurusan='$nama_jurusan' WHERE id_jurusan='$id_jurusan'";
		$hasil = mysqli_query($koneksi, $sql);
		if($hasil) 
		{
			echo "<script>alert('Data Berhasil Diupdate'); document.location.href='http://localhost/chika/admin/jurusan.php'; </script>";
		} 
		else 
		{
			echo "<script>alert('Proses Gagal'); document.location.href='http://localhost/chika/admin/jurusan.php'; </script>";
		}
	}
	?>
	<?php
    ...
    <div class='span12'>
      <div class='widget-box'>
        ...
        "<div class='widget-content nopadding'>
          <form method='post' class='form-horizontal' action='ubahjurusan.php' enctype='multipart/form-data'>
			<div class='control-group'>
			<label class='control-label'>ID Jurusan :</label>
              <div class='controls'>
                <input type='text' name='id_jurusan' class='span11'  value='".$data['id_jurusan']."'/>
              </div>
            </div>
			<label class='control-label'>
			  ...
			  $sql2="SELECT * FROM fakultas";
				...
				while ($data2= mysqli_fetch_array($hasil2)){
					echo"
					<option value='".$data2['id_fakultas']."'>";
					echo $data2['nama_fakultas']; "</option>";
					} } 
					echo"
			</select>
			</div>
			...
			<label class='control-label'>Nama Jurusan :</label>
              <div class='controls'>
                <input type='text' name='nama_jurusan' class='span11'  value='".$data['nama_jurusan']."'/>
              </div>
            </div>
