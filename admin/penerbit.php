        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahpenerbit.php?id_penerbit=<?php echo $data['id_penerbit']?>" class="btn btn-info">Ubah</a>
						<a href="hapuspenerbit.php?id_penerbit=<?php echo $data['id_penerbit']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahpenerbit.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
