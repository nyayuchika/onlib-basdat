        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM rak,blok WHERE rak.id_blok=blok.id_blok";
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahrak.php?id_rak=<?php echo $data['id_rak']?>" class="btn btn-info">Ubah</a>
						<a href="hapusrak.php?id_rak=<?php echo $data['id_rak']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahrak.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
