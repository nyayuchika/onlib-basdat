        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal">
			<div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="id_fakultas" class="span11"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Fakultas :</label>
              <div class="controls">
                <input type="text" name="nama_fakultas" class="span11"/>
              </div>
            </div>
			...
			<?php
				...
				{
				$sql=$koneksi->query("INSERT INTO fakultas(id_fakultas,nama_fakultas) VALUES('$_POST[id_fakultas]','$_POST[nama_fakultas]')");
				if($sql)
				{
					echo "<script>alert('Data berhasil ditambahkan'); window.location = 'fakultas.php'</script>";
				}
				else
				{
					echo "<script>alert('Proses gagal'); window.location = 'tambahfakultas.php'</script>";
				}
				}
			?>
          </form>
