          ...
          <div class="table-responsive">
			...
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					<td><?php echo $no++; ?></td>
					<td><?php echo $data['id_lantai'];?></td>
					<td><?php echo $data['nama_lantai'];?></td>
					<td>
						<a href="ubahlantai.php?id_lantai=<?php echo $data['id_lantai']?>" class="btn btn-info">Ubah</a>
						<a href="hapuslantai.php?id_lantai=<?php echo $data['id_lantai']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahlantai.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
	  </div>
