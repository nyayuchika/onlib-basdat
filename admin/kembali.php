...
<div id="content">
 ...
 <?php
	...
	if(isset($_POST['kirim']))
	{
		...
		$cari_hari = abs(strtotime($_POST['tgl_pinjam']) - strtotime($_POST['tgl_kembali']));
		...
		$sql="UPDATE faktur_peminjaman SET no_pinjam='$no_pinjam', nim='$nim', tgl_pinjam='$tgl_pinjam', tgl_batas_pinjam='$tgl_batas_pinjam', tgl_kembali='$tgl_kembali', total_buku='$total_buku', denda='$denda', id_status='S03' WHERE no_pinjam='$no_pinjam'";
		$hasil = mysqli_query($koneksi, $sql);
		if($hasil) 
		{
			echo "<script>alert('Konfirmasi pengembalian sukses'); document.location.href='http://localhost/chika/admin/kartu.php'; </script>";
		} 
		else 
		{
    ...
    <div class='span12'>
      <div class='widget-box'>
        ...
        "<div class='widget-content nopadding'>
          <form method='post' class='form-horizontal' action='kembali.php' enctype='multipart/form-data'>
		  <label class='control-label'>Tanggal Kembali :</label>
			...
			<div class='control-group'>
              <div class='controls'>
                <input type='hidden' name='no_pinjam' class='span11'  value='".$data['no_pinjam']."'/>
              </div>
            </div>
			<div class='control-group'>
              <div class='controls'>
                <input type='hidden' name='nim' class='span11'  value='".$data['nim']."'/>
              </div>
            </div>
			<div class='control-group'>
              <div class='controls'>
