        ...
        <div class="widget-box">
         ...
         <div class="panel-body">
          <div class="table-responsive">
			...
			<?php
			include "config.php";
			$sql="SELECT * FROM buku JOIN kelompok_buku ON buku.id_kelompok=kelompok_buku.id_kelompok JOIN penerbit ON buku.id_penerbit=penerbit.id_penerbit JOIN tingkat ON buku.id_tingkat=tingkat.id_tingkat";
			$hasil=mysqli_query($koneksi, $sql);?>
              ...
              <tbody>
				...
				<tr>
					...
					<td>
						<a href="ubahbuku.php?id_buku=<?php echo $data['id_buku']?>" class="btn btn-info">Ubah</a>
						<a href="hapusbuku.php?id_buku=<?php echo $data['id_buku']?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')" name="hapus" class="btn btn-danger">Hapus</a>
					</td>
				</tr>
					<?php 
						} } 
			...
			<a href="tambahbuku.php" class="btn btn-primary">Tambah Data</a>
          </div>
        </div>
      </div>
    </div>
